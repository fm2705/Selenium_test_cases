...
public class createNewList12 {
	...
	public void addList() {
		driver.findElement(
				By.xpath("//div[@id='left_menu']//div[2]//header[1]//div[1]//button[1]//*[local-name()='svg']"))
				.click();
		driver.findElement(By.xpath("//input[@id='edit_project_modal_field_name']")).sendKeys("Classes");
		driver.findElement(By.xpath("//button[@class='ist_button ist_button_red']")).click();

		boolean status = driver
				.findElement(By.xpath("//header[@class='view_header']//span[contains(text(),'Classes')]"))
				.isDisplayed();
