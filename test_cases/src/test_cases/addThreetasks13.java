...
public class addThreetasks13 {
	...
	public void addThreeTasksToList() throws InterruptedException {
...
//task 3
		...
		boolean status = driver.findElement(By.xpath("//span[contains(text(),'CSC4000')]")).isDisplayed();
