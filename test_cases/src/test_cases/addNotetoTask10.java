...
public class addNotetoTask10 {
	...
	public void importantTask() throws InterruptedException {
		...
		// click the list
		WebElement note = driver.findElement(By.xpath("//li[36]//div[1]//div[3]//button[4]"));
		note.click();
				
		Thread.sleep(2000);

		note.sendKeys("Adding a note to this task");
	     driver.findElement(By.xpath("//button[@class='ist_button ist_button_red sel_submit_note']")).click();
		

		boolean status = driver.findElement(By.xpath(
				"//a[@class='ist_button ist_button_red link_cta']"))
				.isDisplayed();
