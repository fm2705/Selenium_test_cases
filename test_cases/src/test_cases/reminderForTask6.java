...
public class reminderForTask6 {
	...
	public void taskRemind() throws InterruptedException {

		WebElement moreActions = driver.findElement(By.xpath("//li[34]//div[1]//div[3]//button[4]"));
		Thread.sleep(2000);
		moreActions.click();
		Thread.sleep(2000);
		WebElement remind = driver
				.findElement(By.xpath("//div[@class='ist_popover']//li[7]"));

		remind.click();


		boolean status = driver.findElement(By.xpath("//a[@class='ist_button ist_button_red link_cta']"))
				.isDisplayed();
