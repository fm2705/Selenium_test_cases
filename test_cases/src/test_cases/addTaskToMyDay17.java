...
public class addTaskToMyDay17 {
	...
	public void addtaskToMyDay() throws InterruptedException {

		// click the list "classes"
		driver.findElement(By.xpath(
				"//div[@class='expansion_panel expansion_panel--expanded']//li[6]//table[1]//tbody[1]//tr[1]//td[2]"))
				.click();
		// click add tasks
		...
		boolean status = driver.findElement(By.xpath("//span[contains(text(),'day 1')]")).isDisplayed();
