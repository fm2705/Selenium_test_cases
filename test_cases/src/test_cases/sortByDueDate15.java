...
public class sortByDueDate15 {
	...
	public void sortByDate() throws InterruptedException {
		...
		// click the menu icon to sort
		driver.findElement(By.xpath("//button[@class='gear_icon icon']")).click();
		Thread.sleep(2000);

		// click the sort option
		driver.findElement(By.xpath("//div[@class='ist_popover']//li[5]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//td[@class='name']//span[contains(text(),'Grocery List')]")).click();
		Thread.sleep(2000);
