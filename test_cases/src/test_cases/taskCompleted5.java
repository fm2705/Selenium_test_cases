...
public class taskCompleted5 {
	...
	public void taskCompleted() throws InterruptedException {
		...
		WebElement checkTask = driver.findElement(By.xpath(
				"//body/div[@id='todoist_app']/div[@id='page_background']/div[@id='app_holder']/div[@id='content_wrapper']/div[@id='content']/div[@id='editor']/div[@id='agenda_view']/div[@class='section']/ul[@class='items']/li[28]/div[1]/button[1]"));

		checkTask.click();
		System.out.println("Bollean: " + checkTask.isSelected());

		boolean status = driver.findElement(By.xpath("//div[@id='editor']")).isDisplayed();

		Assert.assertTrue(status);
		System.out.println("========Complete task checked==========");
	}
