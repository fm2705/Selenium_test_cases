...
public class editTaskDueDate18 {
	...
	public void editDueDate() throws InterruptedException {
		...
		driver.findElement(By.xpath("//li[5]//div[1]//div[3]//button[2]//*[local-name()='svg']")).click();
		Thread.sleep(2000);

		driver.findElement(By.xpath(
				"//button[@class='calendar__day calendar__day--busy']//span[@class='calendar__day__date__number'][contains(text(),'26')]"))
				.click();
